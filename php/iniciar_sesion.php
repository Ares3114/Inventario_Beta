<?php
    ...
    $check_user=conexion();
    $check_user=$check_user->query("SELECT * FROM administrador WHERE usuario='$usuario'");
    if($check_user->rowCount()==1){
    	...
    	if($check_user['usuario']==$usuario && password_verify($clave, $check_user['clave'])){
    		...
    		$_SESSION['id']=$check_user['id_administrador'];
    		$_SESSION['nombre']=$check_user['nombre'];
    		$_SESSION['apellido']=$check_user['apellidos'];
