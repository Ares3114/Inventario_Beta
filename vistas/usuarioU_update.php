...
<div class="container is-fluid mb-6">
	<?php if($id==$_SESSION['id']){ ?>
		...
		<h2 class="subtitle">Actualizar los datos del Usuario U</h2>
	<?php }else{ ?>
		<h1 class="title">Usuarios</h1>
		<h2 class="subtitle">Actualizar Usuario U</h2>
	<?php } ?>
</div>
...
<div class="container pb-6 pt-6">
	...
	<form action="./php/usuarioU_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off"  >

		<input type="hidden" name="id_usuarioU" value="<?php echo $datos['id_usuarioU']; ?>" required >
