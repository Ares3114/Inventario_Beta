...
<div class="container is-fluid mb-6">
	...
	<?php }else{ ?>
		...
		<h2 class="subtitle">Actualizar Administrador</h2>
	<?php } ?>
</div>
...
<div class="container pb-6 pt-6">
	...
	<form action="./php/usuario_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<input type="hidden" name="id_administrador" value="<?php echo $datos['id_administrador']; ?>" required >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Usuario</label>
				  	<input class="input" type="text" name="usuario" pattern="[a-zA-Z0-9]{4,20}" maxlength="20" required value="<?php echo $datos['usuario']; ?>" >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
		...
		<div class="columns">
			<div class="column">
		    	<div class="control">
					<label>Clave</label>
				  	<input class="input" type="password" name="clave_1" pattern="[a-zA-Z0-9$@.-]{7,100}" maxlength="100" >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Repetir clave</label>
				  	<input class="input" type="password" name="clave_2" pattern="[a-zA-Z0-9$@.-]{7,100}" maxlength="100" >
				</div>
		  	</div>
		</div>
		<br><br><br>
